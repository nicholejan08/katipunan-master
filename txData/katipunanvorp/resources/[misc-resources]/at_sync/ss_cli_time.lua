...
AddEventHandler(
    ...
    function(serverSecondOfDay, serverDate, isTimeFrozen)
        frozen = isTimeFrozen
...
Citizen.CreateThread(
    function()
        ...
        while true do
            ...
            NetworkClockTimeOverride(math.floor(secondOfDay / 3600), math.floor((secondOfDay - (h * 3600)) / 60), secondOfDay - (math.floor(secondOfDay / 3600) * 3600) - (math.floor((secondOfDay - (h * 3600)) / 60) * 60), 0, true)
        end
    end
)
