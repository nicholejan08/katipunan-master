...
AddEventHandler("changeWeather", function(newWeather,blackout,startup)
    ...
    --print(newWeather, currentWeather)
    if newWeather ~= currentWeather then
        ...
        if startup then
            ...
            SetWeatherTypeTransition(currentWeather, newWeather, 1.00)
        else
            --TraceMsg("Change Weather: "  ..newWeather.. "\n",true)
            --TraceMsg("Change Wind Value: " ..tostring(ss_wind_speed_Mult[newWeather] + 0.10).. "\n",true)
            SetWeatherTypeTransition(currentWeather, newWeather, (ss_weather_timer*60/8) + 0.1)
            transistioning = true
...
Citizen.CreateThread(function()
    while true do
        ...
        if transistioning == false then
            ...
            SetWeatherTypeTransition(currentWeather, newWeather)
