...
Config.BathingZones = {
	...
	["Annesburg"] = {
		...
		lady = `A_F_O_BtcHillbilly_01`,
		guy = `A_M_O_BtcHillbilly_01`,
		door = -201071322
	},
	["Strawberry"] = {
		...
		lady = `CS_BATHINGLADIES_01`,
		guy = `U_M_M_FINALE2_AA_UPPERCLASS_01`,
		door = 1256786197
	},
	["Blackwater"] = {
...
Config.Prompts = {
    { label = ("Maligo sa halagang 5 pesos"), id = "START_BATHING" },

	{ label = "Linisin ang Katawan", id = "SCRUB", control = `INPUT_CONTEXT_X`, time = 2000 },
    { label = ("Magpatulong sa iba sa halagang 15 pesos"), id = "REQUEST_DELUXE_BATHING" },

	{ label = "Tapusin ang pagligo", id = "STOP_BATHING", control = `INPUT_INTERACT_NEG` }
}
