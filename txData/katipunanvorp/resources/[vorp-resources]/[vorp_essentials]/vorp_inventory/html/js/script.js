...
window.addEventListener('message', function (event) {
    ...
    if (event.data.action == "display") {
        ...
        $("#inventoryHud").append(
            `<div class='controls'><div class='controls-center'><div class='search'><input type='text' id='search' placeholder='search items..' /><img class="search" src="../html/img/search-icon.png" alt=""></div><button id='check'>${checkxy} / ${infoxy}</button><img class="satchel" src="../html/img/satchel-icon.png" alt=""></div></div></div>`
        );
