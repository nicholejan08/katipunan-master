    ...
    $.each(items, function (index, item) {
        ...
        if (item.type !== "item_weapon") {
            $("#secondInventoryElement").append(`
                ...
                style='background-image: url(\"img/items/${item.name.toLowerCase()}.jpg\"), url(); background-size: 70px 70px, 70px 70px; background-repeat: no-repeat; background-position: center;'
            ...
            ".jpg\"), url(); background-size: 70px 70px, 70px 70px; background-repeat: no-repeat; background-position: center;' id='item-" +
